...
/* package hide-0.1.0.0 */
#ifndef VERSION_hide
#define VERSION_hide "0.1.0.0"
#endif /* VERSION_hide */
#ifndef MIN_VERSION_hide
#define MIN_VERSION_hide(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hide */
...
/* package text-show-3.10.4 */
#ifndef VERSION_text_show
#define VERSION_text_show "3.10.4"
...
#define CURRENT_COMPONENT_ID "hide-0.1.0.0-inplace-hide"
